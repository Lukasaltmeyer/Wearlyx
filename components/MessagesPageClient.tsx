  ...
  return (
    <div className="min-h-[100dvh] bg-[#07070A] pb-24">
      ...
      <div className="flex border-b border-white/6">
        ...
        >
          Messages
          {tab === "messages" && <div className="absolute bottom-0 left-0 right-0 h-[2px] rounded-full" style={{ background: "#8B5CF6" }} />}
        </button>
        <button
        ...
        >
          Notifications
          {tab === "notifications" && <div className="absolute bottom-0 left-0 right-0 h-[2px] rounded-full" style={{ background: "#8B5CF6" }} />}
        </button>
      </div>
            ...
            <div className="flex flex-col items-center justify-center py-16 text-center px-6">
              <div className="relative w-24 h-24 mb-5">
                <div className="absolute inset-0 rounded-3xl"
                  style={{ background: "linear-gradient(135deg, rgba(139,92,246,0.12), rgba(139,92,246,0.04))", border: "1px solid rgba(139,92,246,0.15)" }} />
                <div className="absolute inset-0 flex items-center justify-center">
                  <MessageCircle className="w-10 h-10" style={{ color: "#8B5CF6" }} />
                </div>
              </div>
                ...
                return (
                  <Link key={conv.id} href={`/messages/${conv.id}`}
                    ...
                    <div className="relative flex-shrink-0">
                      ...
                      <div className="absolute -bottom-1 -right-1 w-6 h-6 rounded-full flex items-center justify-center border-2 border-[#07070A]"
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {product && <p className="text-[11px] font-semibold mt-0.5 truncate" style={{ color: "#8B5CF6" }}>{product.title}</p>}
