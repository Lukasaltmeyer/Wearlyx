      ...
      <div className="flex flex-col gap-2">
        {challenges.map((challenge) => {
          ...
          const typeColor =
            ...
            challenge.type === "weekly"  ? "#8B5CF6" : "#F59E0B";
            ...
            <div key={challenge.id}
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="text-[10px] flex-shrink-0 font-bold text-[#8B5CF6] flex items-center gap-0.5">
                    <Zap className="w-2.5 h-2.5 fill-[#8B5CF6]" />
                    +{challenge.reward}
                  </span>
                </div>
