  ...
  return (
    <div className="px-4 py-6">
      ...
      <Link href="/sell/ai" className="block mb-4 active:scale-[0.98] transition-transform">
        <div className="relative rounded-xl overflow-hidden px-4 py-3"
          ...
          <div className="relative z-10 flex items-center gap-3">
            ...
            <div>
              <p className="text-white font-black text-[13px]">Sois le premier à vendre !</p>
              <p className="text-white/65 text-[11px]">Publie un article en 30s avec l&apos;IA</p>
            </div>
          </div>
        </div>
      </Link>
