...
export default async function HomePage({
  ...
  return (
    <>
      {isMobile && <Navbar />}
      <main className="w-full min-h-[100dvh]" style={{ background: "#0A0A0A", paddingBottom: isMobile ? "160px" : 0 }}>
        <HomePageRouter
      ...
      {isMobile && (
        <div className="fixed bottom-[56px] left-0 right-0 z-[60] flex items-center justify-center gap-2 py-2 border-t border-white/6"
