...
export async function GET(req: NextRequest) {
  ...
  return new NextResponse(
    ...
    <style>body{font-family:system-ui,sans-serif;background:#07070A;color:white;display:flex;align-items:center;justify-content:center;height:100vh;margin:0;text-align:center;}
    .card{background:#0E0E16;border:1px solid #1a1a2e;border-radius:20px;padding:40px;max-width:400px;}
    h1{font-size:22px;font-weight:900;margin:0 0 12px;}p{color:#a0a0c0;font-size:14px;margin:0 0 20px;}
    a{display:inline-block;background:linear-gradient(135deg,#8B5CF6,#7C3AED);color:white;text-decoration:none;padding:12px 24px;border-radius:12px;font-weight:700;font-size:14px;}</style>
    </head><body>
    <div class="card">
