  ...
  return (
    <div className="min-h-[100dvh] bg-white flex flex-col">
      <div className="px-6 pt-14 pb-8">
        <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-[#8B5CF6] to-[#8B85FF] flex items-center justify-center mb-6 shadow-lg shadow-[#8B5CF6]/25">
      ...
      <form onSubmit={handleLogin} className="flex-1 px-6 flex flex-col gap-4">
        ...
        <div className="text-center">
          <p className="text-sm text-gray-500">
            ...
            <Link href="/auth/signup" className="text-[#8B5CF6] font-semibold">
              Créer un compte
            </Link>
          </p>
        </div>
